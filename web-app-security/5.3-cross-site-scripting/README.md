...
> 1. [ XSS Anatomy](broken-reference)
> 2. [Reflected XSS](broken-reference)
> 3. [Stored XSS](broken-reference)
> 4. [DOM-Based XSS](broken-reference)
> 5. [Identifying & Exploiting XSS with XSSer](broken-reference)
