...
> 1. [ XSS Anatomy](../../../ecpptv3/web-app-security/5.3-cross-site-scripting/5.3.1-cross-site-scripting.md)
> 2. [Reflected XSS](../../../ecpptv3/web-app-security/5.3-cross-site-scripting/5.3.2-anatomy-of-an-xss-exploitation.md)
> 3. [Stored XSS](../../../ecpptv3/web-app-security/5.3-cross-site-scripting/5.3.3-the-three-types-of-xss.md)
> 4. [DOM-Based XSS](../../../ecpptv3/web-app-security/5.3-cross-site-scripting/5.3.4-finding-xss.md)
> 5. [Identifying & Exploiting XSS with XSSer](../../../ecpptv3/web-app-security/5.3-cross-site-scripting/5.3.5-xss-exploitation.md)
